...
Public-service availability changes independently of the module. Imported configurations and credentials are supplied by the user; no credential-bearing source collection is bundled.

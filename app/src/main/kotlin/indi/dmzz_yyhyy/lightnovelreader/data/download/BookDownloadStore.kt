...
import indi.dmzz_yyhyy.lightnovelreader.data.image.sourceImageCacheKey
...
class BookDownloadStore @Inject constructor(@ApplicationContext private val context: Context,
    private val database: LightNovelReaderDatabase, private val decoder: ContentJsonDecoder) {

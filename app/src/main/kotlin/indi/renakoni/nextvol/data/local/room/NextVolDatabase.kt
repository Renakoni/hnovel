package indi.renakoni.nextvol.data.local.room
...
import indi.renakoni.nextvol.data.local.room.dao.StorageStatsDao
...
abstract class NextVolDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: NextVolDatabase? = null

        fun getInstance(context: Context): NextVolDatabase {
            synchronized(this) {
                var instance = INSTANCE
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        context.applicationContext,
                        NextVolDatabase::class.java,
                        NAME
                    )
                        .addMigrations(
                            MIGRATION_6_7,

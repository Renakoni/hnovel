...
class BookDownloadTest {
    ...
    private fun openLibrary() {
        db = Room.databaseBuilder(context, LightNovelReaderDatabase::class.java, directory.root.resolve("library.db").path)
            .addMigrations(LightNovelReaderDatabase.MIGRATION_17_18).allowMainThreadQueries().build()
    ...
    @Test fun orphanCleanupRetainsDownloadedChaptersRemovedFromRemoteCatalog() = runBlocking {
        ...
        val model = indi.dmzz_yyhyy.lightnovelreader.ui.bookmanager.BookManagerViewModel(
